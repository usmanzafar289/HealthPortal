(function ($) {
    ...
    $('#btnStickUpSizeToggler').click(function () {
        ...
        if (size == "mini") {
            ...
            $('#myModal').modal('show')
            if (size == "default") { modalElem.children('.modal-dialog').removeClass('modal-lg'); } else if (size == "full") { modalElem.children('.modal-dialog').addClass('modal-lg'); }
        }
    });
    ...
    $('.btn-toggle-layout').click(function () {
        ...
        $(this).addClass('active'); switch (action)
        {
            case 'menuDefault': resetMenu();
                layoutOption = '1'; break;
            case 'menuPinned': resetMenu();
                $('body').addClass('menu-pin');
                layoutOption = '2';
                break;
            case 'menuBelow': resetMenu();
                $('body').addClass('menu-behind');
                layoutOption = '3';
                break;
            case 'menuPinnedBelow': resetMenu();
